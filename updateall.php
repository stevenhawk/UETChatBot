...
if ( ! isUserExist($ID) ) { // nếu chưa tồn tại thì update lên sever
    mysqli_query($conn, "INSERT INTO users (ID, trangthai, hangcho ,gioitinh, room) VALUES ($ID, 0, 0 , $gioitinh, 1)");
  }
  else
  {

    mysqli_query($conn, "UPDATE users SET room = 1 WHERE ID = $userid");
  }
